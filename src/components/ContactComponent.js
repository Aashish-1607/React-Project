...
class Contact extends Component {
    ...
    handleInputChange(event) {
        ...
        //name should be equal to state name
        this.setState({
            [name]: value
        });
    }
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            ...
            errors.firstname = 'First Name should be lesser than or equal to 10 characters';        
    
        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Last Name should be greater than or equal to 3 characters';
        else if(this.state.touched.lastname && lastname.length > 10)    
            errors.lastname = 'Last Name should be lesser than or equal to 10 characters';        
