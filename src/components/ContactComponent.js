...
class Contact extends Component {
    ...
    handleSubmit(values) {
        this.props.postComment(values.firstname, values.lastname, values.telnum, values.email, values.contactType, values.message);
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">                                <Label htmlfor="telnum" md={2}>Telephone Number</Label>
                                <Col md={10}>
                            ...
                            <Row className="form-group">                                <Label htmlfor="feedback" md={2}>Your Feedback</Label>
                                <Col md={10}>
